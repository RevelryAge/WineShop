		...
		<tr>
			<td>
				<div class="dtree">
					...
					<s:if test="#session.existAdminUser.uid != 1">
						<script type="text/javascript">
							d = new dTree('d');
							d.add('01',-1,'系统菜单树');
							...
							d.add('0106','01','管理员管理');
							d.add('010601','0106','个人信息修改','${pageContext.request.contextPath}/adminUser_edit.action?uid=<s:property value="#session.existAdminUser.uid"/>','','mainFrame');
							d.add('0107','-1','退出','${pageContext.request.contextPath}/adminUser_quit.action','','_parent');
							document.write(d);
						</script>
					</s:if>
					<s:if test="#session.existAdminUser.uid == 1">
						<script type="text/javascript">
							...
							d.add('010501','0105','订单管理','${pageContext.request.contextPath}/adminOrder_findAll.action?page=1','','mainFrame');
							d.add('0106','01','管理员管理');
							d.add('010601','0106','管理员管理','${pageContext.request.contextPath}/adminUser_findAll.action?page=1','','mainFrame');
							d.add('0107','-1','退出','${pageContext.request.contextPath}/adminUser_quit.action','','_parent');
							document.write(d);
						</script>
					</s:if>
